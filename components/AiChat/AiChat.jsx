...
import { AtSign, X, MessageSquare, Upload, FileText } from 'lucide-react';
        ...
        <div className="bg-light rounded shadow w-100" style={{ maxWidth: '800px', maxHeight: '500px', overflowY: 'auto',marginLeft:'300px' }}>
          ...
          <div className="flex-grow-1 p-3" style={{ overflowY: 'auto', maxHeight: '300px' }}>
            {messages?.map((message, index) => (
              <div key={index} className={`d-flex ${message.sender === 'user' ? 'justify-content-end' : 'justify-content-start'} mb-2`}>
                <div className={`rounded p-2 ${message.sender === 'user' ? 'bg-primary text-white' : 'bg-light text-dark'}`}
